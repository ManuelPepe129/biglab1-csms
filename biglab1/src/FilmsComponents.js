...
function Films(props){
    ...
    return(
        ...
        {
          films.map((f) => <FilmData film={f} key={f.id} />)
        }
        </ul>
            ...
            <div class="d-flex w-100 justify-content-between">
              ...
              { times(5, (i) => (
                (props.film.rating != undefined) ?
                    (props.film.rating > i) ? <Star/> : <EmptyStar/>
                    : ""
              ))} 
              </div>              
            </div>
...
function EmptyStar(){
    return(
        <svg class="empty-star" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
